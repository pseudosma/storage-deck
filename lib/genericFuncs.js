...
exports.addToStorageGeneric = (keyValue, store) => {
    ...
    keys.forEach(ke => {
        if (typeof ke === "string") {
            ...
            if (ke instanceof RegExp) {
                ...
                Object.keys(storage).forEach(k => {
                    if (searchability_1.Search(ke, k)) {
                        const r = {
                            key: k,
                            value: storageInstance.getItem(k)
                        };
...
exports.retrieveFromStorageGeneric = (keys, store, isCustomStorage) => {
    ...
    keys.forEach(key => {
        if (typeof key === "string") {
            ...
            if (key instanceof RegExp) {
                ...
                Object.keys(storage).forEach(k => {
                    if (searchability_1.Search(key, k)) {
                        storageInstance.removeItem(k);
                    }
                });
            }
...
exports.removeFromStorageGeneric = (keys, store, isCustomStorage) => {
    if (typeof keys === "string") {
