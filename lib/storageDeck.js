...
exports.getStorageInstance = exports.createNewCustomStorage = exports.StorageScheme = exports.reservedOverflowNames = exports.reservedBaseNames = void 0;
...
})(StorageScheme || (exports.StorageScheme = StorageScheme = {}));
class CustomStorage {
    constructor() {
        this.storage = [];
        this.getItem = (key) => {
...
const createNewCustomStorage = (name) => {
...
exports.createNewCustomStorage = createNewCustomStorage;
const getStorageInstance = (name) => {
    ...
    if (exports.reservedBaseNames.indexOf(name) > -1) {
        ...
        if (typeof window[name] !== "undefined") {
            ...
            (0, exports.createNewCustomStorage)(name);
            store = window[name];
